...
import ChartAndExCode from './pages/ChartAndExCode';
    ...
    <div className="h-screen flex bg-slate-100 overflow-hidden">
      <aside className="w-64 shrink-0 bg-slate-900 text-slate-100 flex flex-col">
        <div className="px-6 py-4 border-b border-slate-800">
          <h1 className="text-lg font-semibold tracking-tight">Ford ศูนย์บริการต้นทุนเงินเชื่อ</h1>
      ...
      <main className="flex-1 flex flex-col min-h-0 px-6 py-6 overflow-hidden">
        <Routes>
          ...
          />
          <Route path="/chart-ex-code" element={<ChartAndExCode />} />
        </Routes>
      </main>
    </div>
  );
